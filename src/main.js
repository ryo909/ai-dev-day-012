import './style.css';
const PROFILE = {"day":"Day012","title":"Context Switch Cost Meter","one_sentence":"タスク切替の見えない損失を可視化する生産性分析ツール。（話題:HN Frontpage）","core_action":"estimate","family":"switch_cost","mechanic":"cost_estimation","input_style":"task_sequence","output_style":"cost_report","audience_promise":"better_time_planning","publish_hook":"切替ロスを数字で可視化","engine":"risk_matrix"};
