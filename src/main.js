import './style.css';
const PROFILE = {"day":"Day012","title":"Weighted Option Calculator","one_sentence":"重み付き評価で候補案の順位変化を比較できる計算ツール。（話題:HN Frontpage）","core_action":"score","family":"weighted_scoring","mechanic":"weighted_formula","input_style":"slider_weights_and_rows","output_style":"ranked_scores","audience_promise":"transparent_tradeoff","publish_hook":"重みを動かすと順位差分が見える","engine":"weighted_calc","interaction_archetype":"weighted_calculator","page_archetype":"calculator_dashboard","output_shape":"ranked_table","state_model":"weights_plus_option_rows","core_loop":"tune weights -> recalc -> compare","component_pack":"slider_panel+ranking_table","scaffold_id":"weighted_calculator","single_shot_text_generator":false};
